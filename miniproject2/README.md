...
- 용어
    ...
    - MRP : Material Requirments Planning 자재 소요 계획
        ...
        - 보통 BOM(Bill Of Material, 제품구조표), 재고정보, 생산계획 등을 기반으로 작덩
        - MES에 포함시켜서도 관리
...
- MQTT Subsriber : MQTT 데이터 수신 및 DB저장
...
- [비전센서](https://www.devicemart.co.kr/goods/view?no=15548729) : 부품 조립상태, 오차, 두께불량
    - 긁힘, 오염, 결함, 조립 오류 탐지
